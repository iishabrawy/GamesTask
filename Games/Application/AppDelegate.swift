...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        applyCustomNavigationAppearance()
        ...
        print(" Documents Directory: \(path ?? "Not found")")

        return true
    }

    func applyCustomNavigationAppearance() {
...
//        UINavigationBar.appearance().backItem?.title = nil
        ...
        UINavigationBar.appearance().tintColor = DesignSystem.AppColors.accentColor.color
        UINavigationBar.appearance().barTintColor = UIColor.white
        UINavigationBar.appearance().titleTextAttributes = [NSAttributedString.Key.font:
                                                                UIFont.systemFont(ofSize: 14),
                                                            NSAttributedString.Key.foregroundColor: DesignSystem.AppColors.accentColor.color]
